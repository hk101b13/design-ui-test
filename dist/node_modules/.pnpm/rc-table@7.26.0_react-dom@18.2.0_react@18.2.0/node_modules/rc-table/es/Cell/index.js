...
import { supportRef } from "../../../../../rc-util@5.38.1_react-dom@18.2.0_react@18.2.0/node_modules/rc-util/es/ref.js";
import { validateValue, getPathValue } from "../utils/valueUtil.js";
...
import { useContextSelector } from "../ContextSelector/index.js";
...
function Cell(_ref2, ref) {
  ...
  var _React$useContext = React.useContext(BodyContext), allColumnsFixedLeft = _React$useContext.allColumnsFixedLeft;
  ...
  var _ref3 = legacyCellProps || {}, cellColSpan = _ref3.colSpan, cellRowSpan = _ref3.rowSpan, cellStyle = _ref3.style, cellClassName = _ref3.className, restCellProps = _objectWithoutProperties(_ref3, _excluded);

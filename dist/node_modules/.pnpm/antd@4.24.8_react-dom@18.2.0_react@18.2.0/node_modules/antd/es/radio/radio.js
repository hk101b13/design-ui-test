...
import Checkbox from "../../../../../rc-checkbox@2.3.2_react-dom@18.2.0_react@18.2.0/node_modules/rc-checkbox/es/index.js";
...
import RadioGroupContext, { RadioOptionTypeContext } from "./context.js";
...
var InternalRadio = function InternalRadio2(props, ref) {
  ...
  var customizePrefixCls = props.prefixCls, className = props.className, children = props.children, style = props.style, customDisabled = props.disabled, restProps = __rest(props, ["prefixCls", "className", "children", "style", "disabled"]);
  ...
  return (
    ...
    }, /* @__PURE__ */ React.createElement(Checkbox, _extends({}, radioProps, {
      type: "radio",
      prefixCls,
      ref: mergedRef
...
const InternalRadio$1 = Radio;
export {
  InternalRadio$1 as default
};

...
import { isValidElement } from "../_util/reactNode.js";
import DefaultListBody, { OmitProps } from "./ListBody.js";
...
var TransferList = /* @__PURE__ */ function(_React$PureComponent) {
  ...
  function TransferList2(props) {
    ...
    _this.renderListBody = function(renderList, props2) {
    ...
    _this.renderItem = function(item) {
      var _this$props$render = _this.props.render, render = _this$props$render === void 0 ? defaultRender : _this$props$render;
    ...
    _this.getSelectAllLabel = function(selectedCount, totalCount) {
      var _this$props = _this.props, itemsUnit = _this$props.itemsUnit, itemUnit = _this$props.itemUnit, selectAllLabel = _this$props.selectAllLabel;
      if (selectAllLabel) {

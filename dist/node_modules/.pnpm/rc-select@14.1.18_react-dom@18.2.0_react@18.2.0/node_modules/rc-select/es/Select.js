...
import RefOptionList from "./OptionList.js";
import SelectContext from "./SelectContext.js";
import { hasValue, toArray } from "./utils/commonUtil.js";
import { fillFieldNames, flattenOptions, injectPropsWithOption } from "./utils/valueUtil.js";
import warningProps, { warningNullOptions } from "./utils/warningPropsUtil.js";
...
var Select = /* @__PURE__ */ React.forwardRef(function(props, ref) {
    ...
    return valueList.map(function(val) {
      ...
      if (option) {
        ...
        if (process.env.NODE_ENV !== "production" && !optionLabelProp) {
          ...
          if (optionLabel !== void 0 && !/* @__PURE__ */ React.isValidElement(optionLabel) && !/* @__PURE__ */ React.isValidElement(rawLabel) && optionLabel !== rawLabel) {
  ...
  var _React$useState = React.useState(null), _React$useState2 = _slicedToArray(_React$useState, 2), activeValue = _React$useState2[0], setActiveValue = _React$useState2[1];
  var _React$useState3 = React.useState(0), _React$useState4 = _slicedToArray(_React$useState3, 2), accessibilityIndex = _React$useState4[0], setAccessibilityIndex = _React$useState4[1];
